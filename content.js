...
// we have to run this in the page's scope instead of 
// extension scope because we are hooking functions
// don't forget to unescape and escape the \` and \$
// for easy debugging and syntax highlighting, 
